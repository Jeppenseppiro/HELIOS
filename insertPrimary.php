<?php
	...
	if(isset($_POST["item_primarySegmentID"])) {
		...
		$item_primarylatitude = $_POST["item_primarylatitude"];
		$item_primarylongitude = $_POST["item_primarylongitude"];
		$query = '';
